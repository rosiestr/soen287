...
<head>
    ...
    <title>Kalamari Market: Beverages</title>
</head>
  ...
  <section class="row pb-2 d-md-none">
      ...
      <section class = "d-none d-md-block">
          <div class = "row">
              ...
              <h4>BEVERAGES</h4> <!--Aisle section title --> <!--CHANGE THIS-->
              </div>
  ...
  <div class = "container-fluid">
    <div class = "row">
      ...
      <main class = "col-xl-10" id = "main">
          ...
          <section class = "row">
              <div class = "col">
                  <a href = "products/bubly.php">
                  <figure>
                      <img src = "images/Beverages/bubly.jpg" class = "thumbnail">
                  </figure>
                  <figcaption><b>$6.49 per case</b> (12X250ML)<br> Sparkling Water, Bubly</figcaption>
                  </a>
              </div>
              <div class = "col">
                  <a href = "products/juicebox.php">
                      <figure>
                          <img src = "images/Beverages/juicebox.jpg" class = "thumbnail">
                      </figure>
                      <figcaption><b>$2.99 per case</b> (6x200ml)<br> Juice Boxes, Kirkland Signature</figcaption>
                  </a>
              </div>
              <div class = "col">
                  <a href = "products/orangejuice.php">
                  <figure>
                      <img src = "images/Beverages/OrangeJuice.png" class = "thumbnail">
                  </figure>
                  <figcaption><b>$4.99 ea.</b> 1.75L<br> Orange Juice, Minute Maid</figcaption>
                  </a>
              </div>
              <div class = "col">
                  <a href = "products/softdrink.php">
                  <figure>
                      <img src = "images/Beverages/softdrink.jpg" class = "thumbnail">
                  </figure>
                  <figcaption><b>$4.99 ea.</b> 12 X 355ml<br>Soft Drink, Various
                  </figcaption>
                  </a>
              </div>
              <div class = "col">
                  <a href = "products/water.php">
                      <figure>
                      <p>ON SALE</p>
                      <img src = "images/Beverages/water.jpg" class = "thumbnail">
                      </figure>
                      <figcaption><b>$1.99 ea.</b> 1L<br>Boxed Water</figcaption>
                  </a>
              </div>
          </section> <!--end of beverage section -->
