    ...
    <article class="container-fluid">
      <div class="row">
        <section class="col-sm-6 d-flex align-items-center">
          <img
            src="../images/Household/laundry.jpg"
        ...
        <section class="col-sm-6">
          ...
          <p>
            <strong style="font-size: larger">$8.99/bottle</strong>
          </p>
          <hr />
          <p>Sold in bottles of 2L</p>
          ...
          <!-- Your laundry will seem like new after using this liquid laundry detergent, Available in different scents -->
          <br />
          <br />
          <form action="/action_page.php">
            ...
            <br />
            <div class="">
              <label for="scents"></label> <br>
              <select name="scents" class="selects" id="select1">
                <option value="none">Select Scent</option>
                <option value="original">Original</option>
                <option value="lavender">Lavender</option>
                <option value="mint">Mint &amp Eucalyptus</option>
                <option value="citrus">Citrus</option>
                <option value="free">Fragrance-free</option>
              </select>
            </div>
          </form>
          <br />
