    ...
    <article class="container-fluid">
      <div class="row">
        ...
        <section class="col-sm-6">
          <h3>Dish Soap</h3>
          <p>
            <strong style="font-size: larger">$2.99/bottle</strong>
          </p>
          <hr />
          <p>Sold in bottles of 700mL</p>
          ...
          <!-- Make all your tableware shiny with this dish soap. Available scents -->
          <br />
          <br />
          <form action="/action_page.php">
            ...
            <div class="">
              ...
              <select name="scents" class="selects" required="required" id="select1">
