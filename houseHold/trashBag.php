    ...
    <article class="container-fluid">
      <div class="row">
        <section class="col-sm-6 d-flex align-items-center">
          <img
            src="../images/Household/trashbag.jfif"
            alt="Trash Bags"
            height="450"
            class="img-fluid"
          />
        ...
        <section class="col-sm-6">
          <h3>Trash Bags</h3>
          <p>
            <strong style="font-size: larger">$9.99/roll</strong>
          </p>
          <hr />
          <p>Sold in rolls of 50 bags</p>
          <p class="smallp">Each bag has a capacity of 30L</p>
          ...
          <form action="/action_page.php">
            <label for="quantity">Enter Desired Number of Rolls :</label><br />
            <input
              type="text"
              value=""
              name="QTY"
