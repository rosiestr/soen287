...
<html lang="en">
  <head>
    ...
    <title>Aluminum Trash Can</title>
  </head>
  <body>
    <!-- HEADER -->
    ...
    <article class="container-fluid">
      <div class="row">
        <section class="col-sm-6 d-flex align-items-center">
          <img
            src="../images/Household/trashcan.jfif"
            alt="Trash Can"
            height="450"
            class="img-fluid"
          />
        ...
        <section class="col-sm-6">
          <h3>Aluminum Trash Can</h3>
          <p>
            <strong style="font-size: larger">$14.99</strong>
          </p>
          <hr />
          <p>Sold with a cover</p>
          <p class="smallp">
            The can and the cover can NOT be purchased seperately
          </p>
          ...
          <form action="/action_page.php">
            <label for="quantity">Enter Desired Number of Products :</label
            ><br />
            <input
              type="text"
              value=""
