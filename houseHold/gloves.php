    ...
    <article class="container-fluid">
      <div class="row">
        <section class="col-sm-6 d-flex align-items-center">
          <img
            src="../images/Household/gloves.jfif"
            alt="Gloves"
            height="450"
            class="img-fluid"
          />
        ...
        <section class="col-sm-6">
          <h3>Latex Gloves</h3>
          <p>
            <strong style="font-size: larger">$0.99/pair</strong>
          </p>
          <hr />
          <p>Sold in pairs</p>
          ...
          <!-- Keep you hands safe from dirt, bleach and other chemicals with these latex gloves They come in different sizes from Extra-Small to Extra-Large to meet all your needs! -->
          <br />
          <br />
          <form action="/action_page.php">
            <div class="">
              <label for="quantity">Enter Desired Number of Pairs :</label><br />
              <input
                type="text"
                value=""
                name="QTY"
