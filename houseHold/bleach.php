...
<html lang="en">
  <head>
    ...
    <title>Concentrated Bleach</title>
  </head>
  <body>
  <!-- HEADER -->
    ...
    <article class="container-fluid">
      <div class="row">
        <section class="col-sm-6 d-flex align-items-center">
          <img
            src="../images/Household/bleach.jpg"
            alt="Concentarted Bleach"
            height="450"
            class="img-fluid"
          />
        </section>
        <section class="col-sm-6">
          <h3>Concentrated Bleach</h3>
          <p>
            <strong style="font-size: larger">$3.99/bottle</strong>
          </p>
          <hr />
          ...
          <!-- High-Concentration bleach for cleaning and sanitization, . -->
          <br />
          <br />
