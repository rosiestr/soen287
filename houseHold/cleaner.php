...
<html lang="en">
  <head>
    ...
    <title>Multi Purpose Cleaner</title>
  </head>
  <body>
    <!-- HEADER -->
    ...
    <article class="container-fluid">
      <div class="row">
        <section class="col-sm-6 d-flex align-items-center">
          <img
            src="../images/Household/cleaner.jpg"
            alt="Mutli Purpose Cleaner"
            height="450"
            class="img-fluid"
          />
        </section>
        <section class="col-sm-6">
          <h3>Mutli-Purpose Cleaner</h3>
          <p>
            <strong style="font-size: larger">$1.99/bottle</strong>
          </p>
          <hr />
          <p>Sold in bottles of 500mL</p>
          ...
          <div id="expandDesc" style="display: none">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
            eiusmod tempor incididunt ut labore et dolore magna aliqua.
          </div>
          <!-- for MORE DESCRIPTION: -->
          <!-- Muti-purpose cleaner with differents bleach concentration to meet all your needs  -->
          <br />
          <br />
          <form action="/action_page.php">
            <div class="">
              <label for="quantity">Enter Desired Number of Bottles :</label
              ><br />
              <input
                type="text"
                value=""
            ...
            <br>
            <div class="">
              <label for="bleach"></label><br />
              <select name="bleach" class="selects" id="select1">
                <option value="none">Select Bleach Concentration</option>
                <option value="null">No Bleach (0%)</option>
                <option value="<low">Low (5-25%)</option>
                <option value="medium">Medium (30-50%)</option>
                <option value="high">High (55-95%)</option>
              </select>
            </div>
          </form>
          <br />
    ...
    <!-- Javascript for clicking a button to reveal menu - provided by w3schools.com-->
    <script>
