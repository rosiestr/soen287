  ...
  <body>
    ...
    <nav class="container-fluid outlined-b outlined-t" id="topbar">
      ...
      <section class="row pb-2 d-md-none">
        <div class="col-3">
          <button id="phoneBtn" class="dropbtn">
            <a href="#"><i class="fas fa-bars px-1"></i></a>
          </button>
          <!--menu button-->
        </div>
        <div class="col-2">
          <button>
            <a href="/index.php"><i class="fas fa-home px-1"></i></a>
          </button>
          <!--home button-->
        </div>
        <div class="col-2">
      ...
      <section class="d-none d-md-block">
        <div class="row">
          <div class="col-md-auto">
            ...
            ></a>
            <!--shopping cart butoon-->
          </div>
          <div
            class="col d-flex justify-content-center align-items-center kmbg"
          ></div>
      ...
      <section class="d-none d-md-block">
        <div class="row px-0 bluebg outlined-t">
          <div class="col-md-auto">
            <a href="#" id="compBtn" class="dropbtn"
              ><i class="fas fa-bars px-1"></i> AISLES</a
            >
            <!--menu button-->
          </div>
          <div class="col">
    ...
    <article class="container-fluid">
      <div class="row">
        <section class="col-sm-6 d-flex align-items-center">
          <img
            src="/images/Bakery/cake.png.png"
            alt="Chocolate Cake"
            height="450"
            class="img-fluid"
          />
        ...
        <section class="col-sm-6">
          ...
          <!--<h4>All sizes</h4>-->
          <p>
            <strong style="font-size: larger">15.99$</strong>
            <!-- >$9.99 for small, 12.99$ for medium, 15.99$ for large</strong> -->
          </p>
          <hr />
          ...
          <form action="/action_page.php">
            <label for="quantity">Enter Desired Number of Cakes :</label><br />
            <input
              type="text"
              value=""
              name="QTY"
