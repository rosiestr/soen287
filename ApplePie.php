...
<html lang="en">
  <head>
    ...
    <title>Kalamari Market: Apple Pie</title>
  </head>
  <body>
    <!-- HEADER -->
    ...
    <article class="container-fluid">
      <div class="row">
        <section class="col-sm-6 d-flex align-items-center">
          <img
            src="/images/Bakery/ApplePie.png"
            alt="ApplePie"
            height="450"
            class="img-fluid"
          />
        ...
        <section class="col-sm-6">
          ...
          <!--<h4>All sizes</h4>-->
          <p>
            <strong style="font-size: larger">$12.00</strong>
          </p>
          <hr />
          ...
          <form action="/action_page.php">
            <label for="quantity">Enter Desired Number of Boxes :</label><br />
            <input
              type="text"
              value=""
              name="QTY"
