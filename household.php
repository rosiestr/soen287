...
<head>
  ...
  <title>Kalamari Market: Household Items</title>
</head>
...
<body>
    ...
    <section class = "d-none d-md-block">
      <div class = "row">
        ...
        <div class= "col d-flex justify-content-center align-items-center">
          <h4>HOUSEHOLD ITEMS</h4> <!--Aisle section title -->
        </div>
  ...
  <div class="container-fluid">
    ...
    <!-- Aisle subsection - Cleaning Products -->
        <section class = "row" id = "cleaning">
          <h4>Cleaning Products</h4>
          <div class = "col" id = "laundry">
            <a href = "houseHold/laundryDetergent.php">
              <figure>
                <img src = "images/Household/laundry.jpg" class = "thumbnail" alt="Laundry Detergent">
              </figure>
              <figcaption><b>$8.99/bottle </b> 1.5L <br> Laundry Detergent</figcaption>
            </a>
          </div>
          <div class = "col">
            <a href = "houseHold/dishSoap.php">
              <figure>
                <img src = "images/Household/dish.jpg" class = "thumbnail" alt="Dish Soap">
              </figure>
              <figcaption><b>$2.99/bottle </b> 700mL <br> Dish Soap</figcaption>
            </a>
          </div>
          <div class = "col">
            <a href = "houseHold/cleaner.php">
              <figure>
                <img src = "images/Household/cleaner.jpg" class = "thumbnail" alt="Multi Purpose Cleaner">
              </figure>
              <figcaption><b>$1.99/bottle </b> 500mL <br> Multi Purpose Cleaner</figcaption>
            </a>
          </div>
          <div class = "col">
            <a href = "houseHold/bleach.php">
              <figure>
                <img src = "images/Household/bleach.jpg" class = "thumbnail" alt="Concentrated Bleach">
              </figure>
              <figcaption><b>$3.99/bottle </b> 2L <br>Concentrated Bleach</figcaption>
            </a>
          </div>
        </section> <!--end of Cleaning Products section -->

      <!-- Aisle subsection - Household Tools -->
        <section class = "row" id = "tools">
          <h4>Household Tools</h4>
          <div class = "col" id = "gloves">
            <a href = "houseHold/gloves.php">
              <figure>
                <img src = "images/Household/gloves.jfif" class = "thumbnail" alt="Latex Gloves">
              </figure>
              <figcaption><b>$0.99/pair </b> Available in different sizes! <br> Latex Household Gloves</figcaption>
            </a>
          </div>
          <div class = "col" id = "trashcan">
            <a href = "houseHold/trashCan.php">
              <figure>
                <img src = "images/Household/trashcan.jfif" class = "thumbnail" alt="Trash Can">
              </figure>
              <figcaption><b>$14.99 ea.</b> 20L <br> Aluminum Trash Can</figcaption>
            </a>
          </div>
          <div class = "col" id = "trashbag">
            <a href = "houseHold/trashBag.php">
              <figure>
                <img src = "images/Household/trashbag.jfif" class = "thumbnail" alt="Trash Bag"></figure>
              <figcaption><b>$9.99/roll</b> 30L <br> Black Trash Bags</figcaption>
            </a>
          </div>
          <div class = "col" id = "broom">
            <a href = "houseHold/broom.php">
              <figure>
                <p>ON SALE</p>
        ...
        <!-- end of Household Tools section -->
  ...
  <!--end of footer -->
  <!-- footer for absolute bottom of page -->
