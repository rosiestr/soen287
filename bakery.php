...
<html lang="en">
  <head>
    ...
    <title>Kalamari Market: Bakery Products</title>
  </head>
      ...
      <section class = "d-none d-md-block">
          <div class = "row">
              ...
              <div class= "col d-flex justify-content-center align-items-center">
                <a href="bakery.php"> <h4>Bakery Products</h4></a> <!--Aisle section title --> <!--CHANGE THIS-->
              </div>
    ...
    <div class = "row">
          ...
          <main class = "col-xl-10" id = "main">
            ...
            <section class = "d-md-none d-flex justify-content-center outlined-tb mt-1">
              <a href="bakery.php"> <h5>Bakery Products</h5></a>
            ...
            <section class = "row">
                <div class = "col">
                      ...
                      <figure>
                        <img src="/images/Bakery/cake.png.png" class = "thumbnail">
                    </figure>
                    <a href="chocolateCake.php"> <figcaption><b> 15.99$ </b><br> Choclolate Cake</figcaption></a>
                ...
                <div class = "col">
                      ...
                      <figure>
                        <img src="/images/Bakery/chocoChipCookie.png" class = "thumbnail">
                      </figure>
                      <a href="chocochipCookie.php"><figcaption><b>$7.00 for 10 pieces. </b><br> Choclolate Chip Cookies</figcaption> </a>
                ...
                <div class = "col">
                      ...
                      <figure>
                          <img src="/images/Bakery/ApplePie.png" class = "thumbnail">
                      </figure>
                      <a href="ApplePie.php"> <figcaption><b>$12.00 </b><br> Apple Pie</figcaption></a>
                ...
                <div class = "col">
                      ...
                      <figure>
                        <img src="/images/Bakery/Croisssants.png" class = "thumbnail">
                    </figure>
                    <a href="Croissants.php"><figcaption><b>$6.00 for 7 pieces. </b><br> Croissants</figcaption> </a>
                ...
                <div class = "col">
                      ...
                      <figure>
                        <img src="/images/Bakery/MiniBagets.png" class = "thumbnail">
                      </figure>
                      <a href="MiniBaget.php"> <figcaption><b>$3.99 for 2 pieces </b><br> Mini Bagets</figcaption></a>


                </div>
            </section> <!--end of food section-->
