...
if (isset($_POST['Login'])) {
 ...
 <html lang="en">
   <head>
     ...
     <title>Kalamari Market: Login Page</title>
   </head>
       ...
       <div class="row">
         <main class="col-xl-10" id="userform">
           ...
           <form class="" action="loginProcess.php" method="post">
             <div class="userdiv" id="loginEmail">
             ...
             <br>
               <div class="userdiv" id="loginPass">
                 <label for="passWord">Password</label>
                 <input type="password"
                   name="passWord"
                   class="user">
               </div>
               <p class="smallp"><a href="#">Forgot Password?</a></p>
               <input type="checkbox" name="Remember">
               Remember Me
               <br>
               <div class="userdiv" id="loginSubmit">
                 <!-- For now, clicking on the button will just bring back to index page -->
                 <input type="submit"
                   name="Login"
                   value="Sign In"
                   class="user">
           ...
           <hr>
           <div class="userdiv" id="linkRegister">
             New to Kalamari Market?
             <br>
           <a href="register.html">  <button type="button" name="button">Register Now!</button> </a>
