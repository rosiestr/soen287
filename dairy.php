...
<head>
    ...
    <title>Kalamari Market: Dairy & Eggs</title>
</head>
    ...
    <section class = "d-none d-md-block">
      <div class = "row">
        ...
        <div class= "col d-flex justify-content-center align-items-center">
          <h4>DAIRY & EGGS</h4> <!--Aisle section title -->
        </div>
        ...
        <main class = "aisle col-xl-10" id = "main">
            ...
            <section class = "row">
                <div class = "col">
                    ...
                    <figure>
                        <p>ON SALE</p>
                        <img src = "images/Dairy/eggs.png" class = "thumbnail" alt = "Eggs">
                    </figure>
                    <figcaption><s>$3.99 </s><b>$2.99/carton </b> <br />Brown eggs, extra
                        large </figcaption>
                    </a>
                </div>
                <div class = "col">
                    <a href = "Dairy/cheese.php" target="_blank">
                        <figure>
                            <p>ON SALE</p>
                            <img src = "images/Dairy/cheese.png" class = "thumbnail"alt = "Cheese" >
                        </figure>
                        <figcaption><s>$6.99</s><b>$4.99/lb</b><br>Australian Swiss Cheese</figcaption>
                    </a>
                </div>
                <div class = "col">
                    ...
                    <figure>
                        <p>ON SALE</p>
                        <img src = "images/Dairy/bococcini.jpg" class = "thumbnail" alt = "bococcini">
                    </figure>
                    <figcaption><s>$3.99</s><b> $2.99/ea.</b> 300g<br>Cocktail Bocconcini, Saputo</figcaption>
                    </a>
                </div>
                <div class = "col">
                    ...
                    <figure>
                        <p>ON SALE</p>
                        <img src = "images/Dairy/yogurtVanilla.jpg" class = "thumbnail" alt = "yogurt">
                    </figure>
                    <figcaption><s>$3.49</s><b> $1.99/ea.</b> 946g <br>Activia Yogurt
                    </figcaption>
                    </a>
                </div>
                <div class = "col">
                    <a href = "Dairy/milk.php" target="_blank">
                        <figure>
                        <img src = "images/Dairy/milk.jpeg" class = "thumbnail" alt = "milk">
                        </figure>
                        <figcaption><b> $3.90/ea.</b> 2L<br> 2% Milk </figcaption>
                    </a>
                </div>
