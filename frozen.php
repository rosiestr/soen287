...
<head>
    ...
    <title>Kalamari Market: Frozen</title>
</head>
...
<body>
      ...
      <section class = "d-none d-md-block">
        <div class = "row">
          ...
          <div class= "col d-flex justify-content-center align-items-center">
            <h4>FROZEN FOOD</h4> <!--Aisle section title -->
          </div>
    ...
    <div class = "container-fluid">
      <div class = "row">
        ...
        <!-- MAIN -->
        <main class = "aisle col-xl-10" id = "main">
            ...
            <section class = "row">
                <div class = "col">
                    <a href = "products/rockyRoad.php" target="_blank">
                    <figure>
                        <img src = "images/Frozen/rockyRoad.jpg" class = "thumbnail" alt = "Rocky Road Ice Cream Bars">
                    </figure>
                    <figcaption><b>$6.99 ea.</b> (4X125ML)<br> Frozen Rocky Road Light Ice Cream Bars, Klondike</figcaption>
                    </a>
                </div>
                <div class = "col">
                    <a href = "products/frozenSpinachPizza.php" target="_blank">
                        <figure>
                            <img src = "images/Frozen/frozenSpinachPizza.jpg" class = "thumbnail"alt = "Frozen Spinach Pizza" >
                        </figure>
                        <figcaption><b>$6.49 ea.</b> 390g<br> Frozen Spinach Thin Crust Pizza, Ristorante</figcaption>
                    </a>
                </div>
                <div class = "col">
                    <a href = "products/frozenMango.php" target="_blank">
                    <figure>
                        <img src = "images/Frozen/frozenMango.jpg" class = "thumbnail" alt = "Frozen Mango">
                    </figure>
                    <figcaption><b>$4.99 ea.</b> 600g<br> Frozen Mango Chunks</figcaption>
                    </a>
                </div>
                <div class = "col">
                    <a href = "products/pizzaPops.php" target="_blank">
                    <figure>
                        <img src = "images/Frozen/pizzaPops.jpg" class = "thumbnail" alt = "Pizza Pops">
                    </figure>
                    <figcaption><b>$3.99 ea.</b> 4 X 100G<br>PILLSBURY Frozen 3 Cheese Pizza Snacks, Pizza Pops
                    </figcaption>
                    </a>
                </div>
                <div class = "col">
                    <a href = "products/iceCreamSandwich.php" target="_blank">
                        <figure>
                        <p>ON SALE</p>
                        <img src = "images/Frozen/iceCreamSandwich.jpg" class = "thumbnail" alt = "Ice Cream Sandwich">
                        </figure>
                        <figcaption><s>$6.99 </s><b>4.99 ea.</b> 12 X 120G<br>CHAPMAN'S
                        Vanilla Super Ice Cream Sandwiches</figcaption>
                    </a>
                </div>
            </section> <!--end of frozen food section -->
