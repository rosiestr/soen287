...
<head>
    ...
    <title>Kalamari Market: Fish & Seafood</title>
</head>
    ...
    <section class = "d-none d-md-block">
      <div class = "row">
        ...
        <div class= "col d-flex justify-content-center align-items-center">
          <h4>SEAFOOD</h4> <!--Aisle section title -->
        </div>
    ...
    <div class = "container-fluid">
      <div class = "row">
        ...
        <main class = "aisle col-xl-10" id = "main">
            ...
            <section class = "d-md-none d-flex justify-content-center outlined-tb mt-1">
                <h5>SEAFOOD </h5>
            </section>
            <section class = "row">
                <div class = "col">
                    <a href = "Seafood/salmon.php" target="_blank">
                    <figure>
                        <img src = "images/Seafood/salmon.png" class = "thumbnail" alt = "Salmon">
                    </figure>
                    <figcaption><b>$4.40 avg. ea. </b> 200g <br> Fresh Salmon </figcaption>
                    </a>
                </div>
                <div class = "col">
                    <a href = "Seafood/shrimp.php" target="_blank">
                        <figure>
                            <img src = "images/Seafood/shrimp.png" class = "thumbnail"alt = "Shrimp" >
                        </figure>
                        <figcaption><b>$4.99 ea. </b> 100g<br> Fresh Raw Shrimp</figcaption>
                    </a>
                </div>
                <div class = "col">
                    <a href = "Seafood/lobster.php" target="_blank">
                    <figure>
                        <img src = "images/Seafood/lobster.png" class = "thumbnail" alt = "Lobster">
                    </figure>
                    <figcaption><b>$22.99 avg. ea.</b> 1-1.25lb<br> Live Lobster </figcaption>
                    </a>
                </div>
                <div class = "col">
                    <a href = "Seafood/calamari.php" target="_blank">
                    <figure>
                        <img src = "images/Seafood/calamari.png" class = "thumbnail" alt = "Calamari">
                    </figure>
                    <figcaption><b>$12.99 ea.</b> 2 lb <br>Calamari Rings
                    </figcaption>
                    </a>
                </div>
                <div class = "col">
                    <a href = "Seafood/mussels.php" target="_blank">
                        <figure>
                        <p>ON SALE</p>
                        <img src = "images/Seafood/transparent-mussel.png" class = "thumbnail" alt = "Fresh Mussels">
                        </figure>
                        <figcaption><strike>$4.79</strike><b> $2.99/lb</b><br> Fresh Mussels </figcaption>
                    </a>
                </div>
