...
<html lang="en">
  <head>
    ...
    <title>Kalamari Market: Contact Us</title>
  </head>
  ...
  <body>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <!-- MAIN -->
        <main class="col-xl-10 py-5">
          <section id = "contactInfo" class="row d-flex justify-content-center align-items-center">
            <div class="col-md-auto">
              <header>
                <h5>Our support team is ready to answer all your questions!</h5>
              </header>
              <article class="gradientbg px-2 pb-2">
                <p class="whitep">
                  Kalamari Market <br />
                  999 Ave Seafood <br />
                  Montreal, Canada <br />
                  T6H 3G5 <br />
                  <b>Phone: 438 999 9999</b>
                  <br />
                  <b>Fax: 234 999 9999</b>
                </p>
              </article>
            </div>
          </section>
    ...
    <footer>
      <div class="outlined-t outlined-b greybg px-3">
        <a href=""><i class="fas fa-phone-square"></i> Contact Us&nbsp&nbsp </a>
        <!--Contact button-->
        <a href="map.php" class="currentLink"
          ><i class="fas fa-map-pin"></i> Find a Store</a
        >
        <!-- map pin button -->
      </div>
    </footer>
