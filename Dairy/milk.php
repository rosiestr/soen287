...
<html lang="en">
  ...
  <body>
    ...
    <section class="col-sm-6">
      <h3>2% Milk</h3>
        <p>
          <strong style="font-size: larger">$3.90/ea.</strong> 2L
        </p>
        <hr />
        <p>
          Beatrice&reg;'s 2% Milk is made in Quebec and contains vitamins A and D
        </p>
        ...
        <form action="/action_page.php">
          ...
          <div class="">
            ...
            <select name="types" class="selects">
              ...
              <option value="partly skimmed">Partly Skimmed Milk</option>
              <option value="homogenized">Homogenized Milk</option>
            </select>
          </div>
        </form>
        <br />
        <label for="subtotal">Subtotal :</label><br>
        <input type="hidden" name="PPRICE" id="PPRICE" value="3.90" disabled/>
