...
<html lang="en">
  ...
  <body>
    ...
    <section class="col-sm-6">
      <h3>Activia Yogurt</h3>
        <p>
          <strong style="font-size: larger">$1.99/lb</strong>
          <s>$3.49/lb</s> Save $1.50/lb
        </p>
        <hr />
        <p>
        ...
        <form action="/action_page.php">
          ...
          <select name="types" class="selects">
            ...
            <option value="vanilla">Vanilla Yogurt</option>
            <option value="strawberry">Strawberry Yogurt</option>
