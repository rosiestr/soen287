...
<html lang="en">
  <head>
    ...
    <title>Australian Swiss Cheese</title>
  </head>
  <body>
    <!-- HEADER -->
    ...
    <section class="col-sm-6">
       <h3>Australian Swiss Cheese</h3>
        <p>
          <strong style="font-size: larger">$4.99/lb</strong>
          <s>$6.99/lb</s> Save $2.00/lb
        </p>
        <hr />
        <p>
          Swiss cheese imported from Australia to elevate your charcuterie boards
        </p>
        ...
        <!--<p>The KALAMARI market mussels can complement your seafood dishes.</p>-->
        <!-- Mussels are rich in the marine Omega-3s, EPA and DHA. If you are trying to lose weight, mussels give you a lot of nutrition without a lot of calories.-->
        <br />
        <br />
        <form action="/action_page.php">
          <div class="">
            <label for="quantity">Enter Desired Pounds :</label><br />
            <input type="text" value="" name="QTY" id="QTY" onKeyUp="calculate()"/>
          </div>
          <br />
          <div class="">
            <label for="types">Select Type</label><br />
            <select name="types" class="selects">
                <option value="none">Select Type</option>
              <option value="canadian">Sliced Cheese</option>
              <option value="blue">Non Sliced Cheese</option>
            </select>
          </div>
        </form>
        <br />
