...
<html lang="en">
    <head>
       ...
       <title>Kalamari Market: Mini Bagets </title>
    ...
    <article class="container-fluid">
      <div class = "row">
        <section class = "col-sm-6 d-flex align-items-center">
          <img
                src="/images/Bakery/MiniBagets.png"
                alt="MiniBagets"
                height="450"
                class="img-fluid"
              />
            ...
            <section class="col-sm-6">
               <h3>Mini Bagets</h3>
                <!--<h4>All sizes</h4>-->
                <p>
                  <strong style="font-size: larger">$3.99 for 2 pieces</strong>
                </p>
                <hr />
                ...
                <input type="hidden" name="PPRICE" id="PPRICE" value="3.99" disabled/>
