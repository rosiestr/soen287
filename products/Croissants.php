...
<html lang="en">
  ...
  <title>Kalamari Market: Bakery </title>
    ...
    <!-- end of navigation-->
    <!--<header>-->
        <article class="musselsarticle">
            <img
        src="images/Croisssants.png"
        alt="Croissants"
        height="450"
        class="imgmussels"
      />
      <class class="container">
        ...
        <!--<h4>All sizes</h4>-->
        <p>
          <strong style="font-size: larger">$6.00 for 7 pieces</strong>
        </p>
        <hr />
    ...
    <footer>
      <div class = "outlined-t outlined-b greybg px-3">
        <a href = "/contact.php"><i class="fas fa-ph9op-0one-square"></i>  Contact Us&nbsp&nbsp   </a> <!--Contact button-->
