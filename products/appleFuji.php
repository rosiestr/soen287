    ...
    <article class="container-fluid">
      <div class = "row">
        <section class = "col-sm-6 d-flex align-items-center">
          <img
            src="../images/Produce/appleFuji.png"
            alt="Apples"
            height="450"
            class="img-fluid"/>
        </section>
        <section class="col-sm-6">
          <h3>Fuji Apple</h3>
          <p>
            <strong style="font-size: larger">$0.89</strong>
          </p>
          <hr />
          ...
          <input type="hidden" name="PPRICE" id="PPRICE" value="0.89" disabled/>
