  ...
  <body>
    ...
    <section class="col-sm-6">
      <h3>Fresh Beef Flank</h3>
        ...
        <!-- Flank steak relatively long and flat cut, with significant graining. Flavorful but chewy, it is characteristically cut Finley on the bias for ease of consumption. -->
        <br />
        <br />
