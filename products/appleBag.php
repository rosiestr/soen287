    ...
    <article class="container-fluid">
      <div class = "row">
        ...
        <section class="col-sm-6">
          <h3>Apples, Granny Smith</h3>
          <p>
            <strong style="font-size: larger">$4.99</strong> (6 apples)
          </p>
          <hr />
          <p>Sold by the bag (approx. 600g)</p>
