...
<html lang="en">
  <head>
    ...
    <title>Kalamari Market: Applewood Smoked Bacon</title>
  </head>
  <body>
    <!-- HEADER -->
    ...
    <article class="container-fluid">
      <div class = "row">
        ...
        <section class="col-sm-6">
          ...
          <p>
            <strong style="font-size: larger">$5.99</strong>  (400g)
          </p>
          <hr />
          <p>Sold by the pack</p>
        ...
        <input type="hidden" name="PPRICE" id="PPRICE" value="5.99" disabled/>
