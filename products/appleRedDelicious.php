...
<html lang="en">
  <head>
    ...
    <title>Fruits: Red Delicious Apple</title>
  </head>
  <body>
    <!-- HEADER -->
    ...
    <article class="container-fluid">
      <div class = "row">
        <section class = "col-sm-6 d-flex align-items-center">
          <img
            src="/images/Produce/appleRedDelicious.png"
            alt="Apples"
            height="450"
            class="img-fluid"
          />
        ...
        <section class="col-sm-6">
          <h3>Red Delicious Apple</h3>
          <p>
            <strong style="font-size: larger">$0.99</strong>
          </p>
          <hr />
          <p>Sold individually (approx. 200g)</p>
          ...
          <input type="hidden" name="PPRICE" id="PPRICE" value="0.99" disabled/>
