...
<html lang="en">
  <head>
    ...
    <title>Vegetables : French Shallots</title>
  </head>
  <body>
    ...
    <article class="container-fluid">
      <div class = "row">
        <section class = "col-sm-6 d-flex align-items-center">
          <img
            src="/images/Produce/shallot.jpg"
            alt="Shallot"
            height="450"
            class="img-fluid"
          />
        ...
        <section class="col-sm-6">
          <h3>French Shallots</h3>
          <p>
            <strong style="font-size: larger">$1.19 ea.</strong>
          </p>
          <hr />
          <p>Sold individually (approx. 120g)</p>
        ...
        <input type="hidden" name="PPRICE" id="PPRICE" value="1.19" disabled/>
