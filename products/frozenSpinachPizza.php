...
<html lang="en">
  <head>
    ...
    <title>Kalamari Market: Frozen Spinach Pizza</title>
  </head>
  <body>
    <!-- HEADER -->
    ...
    <article class="container-fluid">
      <div class = "row">
        <section class = "col-sm-6 d-flex align-items-center">
          <img
            src="/images/Frozen/frozenSpinachPizza.jpg"
            alt="Frozen Spinach Pizza"
            height="450"
            class="img-fluid"
          />
        </section>
        <section class="col-sm-6">
          <h4>RISTORANTE</h4>
          <h3>Frozen Spinach Thin Crust Pizza</h3>
          <p>
            <strong style="font-size: larger">$6.49</strong>  (390g)
          </p>
          <hr />
