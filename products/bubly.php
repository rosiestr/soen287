...
<html lang="en">
  <head>
    ...
    <title>Bubly Sparkling Water</title>
  </head>
  <body>
    <!-- HEADER -->
    ...
    <article class="container-fluid">
      <div class = "row">
        <section class = "col-sm-6 d-flex align-items-center">
          <img
        src="../images/Beverages/bubly.jpg"
        alt="Bubly Sparkling Water"
        height="450"
        class="img-fluid"
      />
    </section>
    <section class="col-sm-6">
      <h3>Sparkling Water, Bubly</h3>
        <p>
          <strong style="font-size: larger">$6.49 per case</strong>
        </p>
        <hr />
        <p>Sold in cases of 12</p>
        ...
        <input type="hidden" name="PPRICE" id="PPRICE" value="6.49" disabled/>
