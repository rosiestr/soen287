...
<html lang="en">
  ...
  <body>
    ...
    <article class="container-fluid">
      ...
      <img
        src="../images/Seafood/mussels2.jpeg"
        alt="Mussels"
        height="550"
        class="img-fluid"
      />
      ...
      <!-- <div class="container"> -->
        ...
        <h3>Fresh Mussels</h3>
        <p id="price" value="2.99">
          <strong style="font-size: larger">$2.99/lb</strong>
          <s>$4.79/lb</s> Save $1.80/lb
        </p>
        <hr />
        <p>
          Fresh mussels of various sizes and types imported from a wide range of
          locations
        </p>
       ...
       <br />
        ...
        <form action="/action_page.php">
          ...
          <select name="types" class="selects" id="select2">
            ...
            <option value="canadian">Canadian Mussels</option>
            <option value="blue">Blue Mussels</option>
            <option value="Mediterranean">Mediterranean Mussels</option>
          </select>
        </form>
        <br />
