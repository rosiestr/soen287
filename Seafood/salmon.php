...
<html lang="en">
  ...
  <body>
    ...
    <article class="container-fluid">
      <div class = "row">
        <section class = "col-sm-6 d-flex align-items-center">
          <img
        src="../images/Seafood/salmon22.jpeg"
        alt="Salmon"
        height="550"
        class="img-fluid"
      />
    ...
    <section class="col-sm-6">
        <h3>Fresh Salmon</h3>
        <p>
          <strong style="font-size: larger">$4.49 avg. ea.</strong> <br>200g avg. ea.
        </p>
        <hr />
        <p>
            Fresh Canadian Pacific salmon fillet
        </p>
        ...
        <form action="/action_page.php">
          ...
          <select name="types" class="selects" id="select1">
            ...
            <option value="chinook">Chinook Salmon</option>
            <option value="chum">Chum Salmon</option>
            <option value="pink">Pink Salmon</option>
          </select>
        </form>
        <br />
        <label for="subtotal">Subtotal :</label><br>
          <input type="hidden" name="PPRICE" id="PPRICE" value="4.49" disabled/>
