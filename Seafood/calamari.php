...
<html lang="en">
  ...
  <body>
      ...
      <article class="container-fluid">
        <div class = "row">
          <section class = "col-sm-6 d-flex align-items-center">
            <img
        src="../images/Seafood/calamari.jpeg"
        alt="Calamari"
        height="450"
        class="img-fluid"
      />
    ...
    <section class="col-sm-6">
        ...
        <p>
          <strong style="font-size: larger">$12.99/lb</strong><br>2 lb

        </p>
        <hr />
        <p>
          Breaded crispy calamari rings
          <br>
          <br>Comes bagged
        </p>
        ...
        <form action="/action_page.php">
          <label for="quantity">Enter Amount of Bags :</label><br />
          <!-- <input type="text" class="quantity" name="quantity" value="0" /><br /> -->
          <input type="text" value="" name="QTY" id="QTY" onKeyUp="calculate()"/>

          <br />

          <label for="types"></label><br />
          <select name="types" class="selects" id="select1">
            <option value="none">Select Type</option>
            <option value="canadian">Fresh Cooked Calamari Rings</option>
            <option value="blue">Frozen Calamari Rings</option>
          </select>
        </form>
        <br />
        <label for="subtotal">Subtotal :</label><br>
        <input type="hidden" name="PPRICE" id="PPRICE" value="12.99" disabled/>
